...
import ClabsisMedicalApplication.TableViewClasses.Diagnosis;
import ClabsisMedicalApplication.TableViewClasses.Encounter;
...
public class RecordController implements Initializable {
    ...
    public void infectionClick(){
        ...
        try{
            ...
            fxmlLoader = new FXMLLoader(getClass().getResource("/ClabsisMedicalApplication/Views/Infection.fxml"));
...
//                System.out.println(rs.getString("Diagnosis_DTG"));
    ...
    public void menuHOMEClicks(ActionEvent event) {
        ...
        try{
            ...
            Parent record = FXMLLoader.load(getClass().getResource("/ClabsisMedicalApplication/Views/Patient.fxml"));
    ...
    public void encounterClick(ActionEvent event){
        try{
            ...
            fxmlLoader = new FXMLLoader(getClass().getResource("/ClabsisMedicalApplication/Views/Encounter.fxml"));
            Parent root = (Parent)fxmlLoader.load();
            window = new Stage();
    ...
    public void procedureClick(ActionEvent event){
        ...
        try{
            ...
            fxmlLoader = new FXMLLoader(getClass().getResource("/ClabsisMedicalApplication/Views/Procedure.fxml"));
            Parent root = (Parent)fxmlLoader.load();
            window = new Stage();
    ...
    public void infectionAdd(ActionEvent event){
        ...
        if(InfectionEncounterID.getText().isEmpty() || InfectionType.getText().isEmpty()
                || DiagnosisDate.getText().isEmpty() || StringUtils.isNullOrEmpty(String.valueOf(InfectionType))){
    ...
    public void infectionUpdate(ActionEvent event){
        ...
        if(InfectionEncounterID.getText().isEmpty() || InfectionType.getText().isEmpty() || DiagnosisDate.getText().isEmpty()) {
